...
<%@page import="com.learn.myshoppingcart.helper.Helper"%>
<%@page import="com.learn.myshoppingcart.dao.CategoryDao"%>
<%@page import="com.learn.myshoppingcart.dao.ProductDao"%>
<%@page import="com.learn.myshoppingcart.helper.FactoryProvider"%>
<%@page import="java.util.List"%>
<%@page import="com.learn.myshoppingcart.entities.*"%>
<html>
<head>
<title>MyShoppingCart: Home</title>
